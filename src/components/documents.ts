...
const mca_final = `\n
  ...
  │   Year - 2(YGPA)│     8.92      │
  ├─────────────────┴───────────────┤
  │\x1b[47m\x1b[30m   DGPA - (Overall):   8.84      \x1b[0m│
  └─────────────────────────────────┘
`
...
const bsc_final = `\n
  ...
  │   Year - 3(YGPA)│    8.498      │
  ├─────────────────┴───────────────┤
  │\x1b[47m\x1b[30m   CGPA - (Overall):  8.211      \x1b[0m│
  └───────────────────────────────────┘
`
...
const hs_result = `\n
  ...
  │   COMPUTER SCIENCE │    82      │
  ├─────────────────────┴───────────┤
  │\x1b[47m\x1b[30m   Total Score:         478      \x1b[0m│
  └─────────────────────────────────┘
`;
...
const icse_result = `\n
  ...
  ├───────────────────────┴───────────┤
  │\x1b[47m\x1b[30m   Total Score:          522       \x1b[0m│
  └───────────────────────────────────┘
`;
